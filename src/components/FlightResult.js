        ...
        <div className="resultCont1">
          ...
          <div className="flexCont">
            ...
            <p>{`Date- ${format(
              ...
              "dd/mm/yyyy"
            )} - ${format(location.state.date[0].endDate, "dd/mm/yyyy")}`}</p>
          ...
          <div className="flexCont1">
            <div className="time">
              <p>
                {" "}
                1<sup>st</sup> flight- 8:55 AM - 1:00 PM
              </p>
              <p>
                {" "}
                2<sup>nd</sup> flight- 10:15 PM - 2:55 AM
              </p>
            </div>
            <div className="price">
              <p className="icons">
              ...
              <p className="carryBag">
                Included: personal item, carry-on bag, <br /> checked bag
              </p>
        ...
        <div className="resultCont1">
          ...
          <div className="flexCont1">
            <div className="time">
              <p>
                {" "}
                1<sup>st</sup> flight- 5:35 PM - 8:20 PM
              </p>
              <p>
                {" "}
                2<sup>nd</sup> flight- 10:15 PM - 6:55 AM
              </p>
            </div>
            <div className="price">
              <p className="icons">
        ...
        <div className="resultCont1">
          ...
          <div className="flexCont1">
            <div className="time">
              <p>
                {" "}
                1<sup>st</sup> flight- 11:05 PM - 2:00AM
              </p>
              <p>
                {" "}
                2<sup>nd</sup> flight- 5:35 PM - 8:20PM
              </p>
            </div>
            <div className="price">
              <p className="icons">
