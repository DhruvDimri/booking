  ...
  return (
    <div className='trending2Container'>
        ...
        <div className="imgContainer">
            <div className="img1">
                <img src={udaipur} alt="sorry" />
                <div className='same'>Udaipur</div>
            </div>
            <div className="img2">
                <img src={goa} alt="sorry" />
                <div className='same'>Goa</div>
            </div>
            <div className="img3">
                <img src={southgoa} alt="sorry" />
                <div className='same'>South Goa</div>
            </div>
            <div className="img4">
                <img src={ayodhya} alt="sorry" />
                <div className='same'>Ayodhya</div>
            </div>
            <div className="img5">
                <img src={puducherry} alt="sorry" />
                <div className='same'>Puducherry</div>
            </div>
            <div className="img6">
                <img src={northgoa} alt="sorry" />
